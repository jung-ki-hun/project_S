...
const WCHAR TITLE_CStockBar[] = L"CStockBar";
...
/*
// IPersist
STDMETHODIMP CStockBar::GetClassID(CLSID *pClassID)
{
	*pClassID = CLSID_StockBar;
	return S_OK;
}

// IPersistStream
STDMETHODIMP CStockBar::IsDirty(void)
{
	return S_FALSE;
}

STDMETHODIMP CStockBar::Load(IStream *pStm)
{
	return S_OK;
}

STDMETHODIMP CStockBar::Save(IStream *pStm, BOOL fClearDirty)
{
	return S_OK;
}

STDMETHODIMP CStockBar::GetSizeMax(ULARGE_INTEGER *pcbSize)
{
	return E_NOTIMPL;
}
*/
