...
const CInterfaceProxyVtbl * _RemOutServer_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _RemOutServer_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IAddEndStubVtbl,
    ( CInterfaceStubVtbl *) &_IAddStubVtbl,
    0
...
PCInterfaceName const _RemOutServer_InterfaceNamesList[] = 
{
    "IAddEnd",
    "IAdd",
    0
...
const IID *  _RemOutServer_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _RemOutServer_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _RemOutServer, pIID, n)

int __stdcall _RemOutServer_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _RemOutServer, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _RemOutServer, 2, *pIndex )
    
}

const ExtendedProxyFileInfo RemOutServer_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _RemOutServer_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _RemOutServer_StubVtblList,
    (const PCInterfaceName * ) & _RemOutServer_InterfaceNamesList,
    (const IID ** ) & _RemOutServer_BaseIIDList,
    & _RemOutServer_IID_Lookup, 
    2,
    2,
