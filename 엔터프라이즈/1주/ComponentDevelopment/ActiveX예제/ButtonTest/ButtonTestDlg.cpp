...
BEGIN_EVENTSINK_MAP(CButtonTestDlg, CDialog)
    //{{AFX_EVENTSINK_MAP(CButtonTestDlg)
	ON_EVENT(CButtonTestDlg, IDC_SKKBUTTON1, 1 /* Clicked */, OnClickedSkkbutton1, VTS_I4 VTS_I4)
	//}}AFX_EVENTSINK_MAP
END_EVENTSINK_MAP()

void CButtonTestDlg::OnClickedSkkbutton1(long x, long y) 
{
