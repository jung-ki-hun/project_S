========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : skkClient
========================================================================


AppWizard has created this skkClient application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your skkClient application.
...
skkClient.h
    ...
    CSkkClientApp application class.
...
res\skkClient.ico
    ...
    icon is included by the main resource file skkClient.rc.
...
skkClientDlg.h, skkClientDlg.cpp - the dialog
    These files contain your CSkkClientDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in skkClient.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CSkkClientDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named skkClient.pch and a precompiled types file named StdAfx.obj.
