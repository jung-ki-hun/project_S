...
const IID IID_IAddBackEvent = {0xAF0E9761,0xECD3,0x11d3,{0x82,0x55,0x00,0x00,0xC0,0xB1,0x10,0x65}};


const IID LIBID_ADDBACKLib = {0x0B39A1A1,0xECAD,0x11D3,{0x82,0x55,0x00,0x00,0xC0,0xB1,0x10,0x65}};


const IID DIID__DIAddBackEvent = {0x9362EF01,0xECD5,0x11d3,{0x82,0x55,0x00,0x00,0xC0,0xB1,0x10,0x65}};
