...
const CInterfaceProxyVtbl * _AddEnd_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IAddEndProxyVtbl,
    0
};

const CInterfaceStubVtbl * _AddEnd_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IAddEndStubVtbl,
    0
};

PCInterfaceName const _AddEnd_InterfaceNamesList[] = 
{
    "IAddEnd",
    0
};

const IID *  _AddEnd_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _AddEnd_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _AddEnd, pIID, n)

int __stdcall _AddEnd_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_AddEnd_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo AddEnd_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _AddEnd_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _AddEnd_StubVtblList,
    (const PCInterfaceName * ) & _AddEnd_InterfaceNamesList,
    (const IID ** ) & _AddEnd_BaseIIDList,
    & _AddEnd_IID_Lookup, 
    1,
    2,
